...
const EXTENDED_TRANSLATIONS: Partial<Record<SupportedLanguage, ExtendedLanguageContent>> = {
  ar: {
    ...
    faqs: [
      ...
      {
        q: 'ما هي خدعة رابط 1k السريع؟',
        a: 'فقط غيّر instagram.com إلى 1kgram.com في رابط إنستغرام وسيفتح التحميل فوراً!',
      },
    ],
    secretShortcutSub: 'أسرع طريقة للتحميل مباشرة من شريط العناوين',
    secretShortcutOriginal: 'الرابط الأصلي:',
    secretShortcutModified: 'غيّر الرابط إلى "1kgram.com" ثم اضغط Enter:',
    ...
    slideLabel: 'شريحة',
    storyLabel: 'ستوري',
    downloadNotice: 'تنبيه التحميل',
    creatorBadge: 'صانع محتوى على انستقرام',
    scanFastBadge: 'يمسح خلال 0.1 ثانية',
    iosGuideTitle: 'آيفون / آيباد (iOS):',
    iosGuideDesc: 'افتح تطبيق الكاميرا ← وجّه نحو الرمز ← اضغط على الإشعار الأصفر ← اضغط تنزيل.',
    androidGuideTitle: 'أندرويد (سامسونج، شاومي، بيكسل):',
    androidGuideDesc: 'افتح الكاميرا أو عدسة Google ← اضغط على الرابط المنبثق ← يُحفظ الملف مباشرة في المعرض.',
    quickTutorialBadge: 'شرح سريع',
    performanceBadge: 'الأداء والموثوقية',
    downloadersColTitle: 'أدوات التحميل',
    guidesColTitle: 'أدلة وشروحات الاستخدام',
    supportedLanguagesTitle: 'اللغات المدعومة',
    controlPanelBtn: 'لوحة التحكم',
    sourceZipBtn: 'تحميل الكود المصدري ZIP',
    availableStreamsTitle: 'الجودات والصيغ المتاحة للتحميل',
    videoLabel: 'فيديو',
    photoLabel: 'صورة',
  },
  es: {
